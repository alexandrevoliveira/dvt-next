...
import ColumnDashboard from "../../components/Dashboard/Column";
...
export default function ColumnDashboardPage() {
  ...
  return (
    <PageCompose header_title="DVT | Column Dashboard">
      <Stack flex="1" direction="column" spacing={[4, 4, 4, 4, 6]} justify="center" align="center">
        ...
        {file && (<Stack w="100%" maxW="680px" h="100%">
          <ColumnDashboard name={file?.name} object={fileObject}/>
        </Stack>)}
      </Stack>
    </PageCompose>
  )
